...
import { fetchWomenList } from '../features/post.slice';
            ...
            <div className="container  py-3">
                ...
                <div className="row">
                    ...
                    <div className="col-12 mb-5">
                        <h1 className='display-6 fw-bolder text-center' style={{ color: '#66232b' }}> True style never dies. </h1>
                        <hr />
                    </div>
                </div>
