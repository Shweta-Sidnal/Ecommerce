...
import { fetchHomedecorationList } from '../features/post.slice';
...
const Homedecoration = () => {
    ...
    useEffect(() => {
        dispatch(fetchHomedecorationList());
    }, [dispatch]);
            ...
            <div className="container  py-3">
                ...
                <div className="row">
                    ...
                    <div className="col-12 mb-5">
                        <h1 className='display-6 fw-bolder text-center' style={{ color: '#66232b' }}> Design your home with passion </h1>
                        <hr />
                    </div>
                </div>
